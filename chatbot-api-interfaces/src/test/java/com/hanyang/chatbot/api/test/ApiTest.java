...
public class ApiTest {
    ...
    public void test_chatGPT() throws IOException {
        ...
        String url = "https://api.chatgptid.net/v1/chat/completions";
        String apiKey = "填写自己的key";
